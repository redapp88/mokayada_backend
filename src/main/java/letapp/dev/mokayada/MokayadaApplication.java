...
public class MokayadaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * 
		 * Arrays.asList(new
		 * Item("Montre","montre casio","neuve",null,appUserRepository.findById(1L).get(
		 * )), new
		 * Item("telephone","galaxy","neuve",null,appUserRepository.findById(1L).get()))
		 ...
		 * .appUserRepository.findById(1L).get()), new
		 ...
		 * this.appUserRepository.findById(1L).get()) ) .forEach(e->{
